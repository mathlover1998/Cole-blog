from flask import Flask, render_template, redirect, url_for, flash,request,session,app,abort
...
def login():
    ...
    if login_form.validate_on_submit():
        ...
        if selected_user:
            if check_password_hash(password=request.form.get('password'),pwhash=selected_user.password):
...
def show_post(post_id):
    ...
    if comment_form.validate_on_submit():
        comment = Comment(text = request.form.get('body'),
    ...
    return render_template("post.html", post=requested_post,form =comment_form,comment_list = comment_list)
